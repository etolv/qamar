            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('employee.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3 d-none">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="password" name="password" value="{{ old('password') ?? 'password' }}"
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 form-label"
                                for="basic-icon-default-phone">{{ _t('Start Working') }}</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-phone2" class="input-group-text"><i
                                            class="fa-solid fa-calendar"></i></span>
                                    <input type="date" value="{{ old('start_work') ?? null }}" name="start_work"
                                        id="start_work" class="form-control" placeholder="{{ _t('Start Working') }}" />
                                </div>
                            </div>
                            @error('start_work')
                                <span class="text-danger">{{ $message }}</span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-phone2" class="input-group-text"><i
                                            class="fa-solid fa-notes-medical"></i></span>
                                    <input type="text" value="{{ old('health_number') ?? null }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-phone2" class="input-group-text"><i
                                            class="fa-solid fa-notes-medical"></i></span>
                                    <input type="text" value="{{ old('passport_number') ?? null }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-phone2" class="input-group-text"><i
                                            class="fa-solid fa-notes-medical"></i></span>
                                    <input type="date" value="{{ old('passport_expiration') ?? null }}"
