        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="post" action="{{route('city.update', $city->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="{{$index.'[name]'}}" value="{{$city->translate($index)?->name}}" required class="form-control" id="basic-icon-default-fullname" placeholder="{{_t('Name') . ' '  . _t($locale)}}" aria-label="{{_t('Name') . ' ' . _t($locale)}}" aria-describedby="basic-icon-default-fullname2" required />
                            </div>
                            @error($index.'[name]')
                    ...
                    <div class="row mb-3">
                        <div class="mb-1">
                            <label class="form-label" for="lang_file_name">{{_t('State')}}</label>
