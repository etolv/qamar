            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('card.update', $card->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') ?? $card->name }}" required
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="ti ti-comment"></i></span>
                                    <input type="text" name="number" value="{{ old('number') ?? $card->number }}"
                                        required class="form-control" id="basic-icon-default-fullname"
                                        placeholder="{{ _t('number') }}" required />
                                </div>
                                @error('number')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">{{ _t('IBAN') }}
                                *</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="ti ti-comment"></i></span>
                                    <input type="text" name="iban" value="{{ old('iban') ?? $card->iban }}" required
                                        class="form-control" id="basic-icon-default-fullname"
                                        placeholder="{{ _t('iban') }}" required />
                                </div>
                                @error('iban')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">{{ _t('CVV') }}
                                *</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="ti ti-comment"></i></span>
                                    <input type="text" name="cvv" value="{{ old('cvv') ?? $card->cvv }}" required
                                        class="form-control" id="basic-icon-default-fullname"
                                        placeholder="{{ _t('CVV') }}" required />
                                </div>
                                @error('cvv')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">{{ _t('Expiry') }}
                                *</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="ti ti-comment"></i></span>
                                    <input type="date" name="expiry" value="{{ old('expiry') ?? $card->expiry }}"
                                        required class="form-control" id="basic-icon-default-fullname"
                                        placeholder="{{ _t('expiry') }}" required />
                                </div>
                                @error('expiry')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
