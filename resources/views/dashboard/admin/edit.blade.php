            ...
            <div class="card-body">
                <form method="post" action="{{route('admin.update', $admin->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="name" value="{{$admin->name}}" required class="form-control" id="basic-icon-default-fullname" placeholder="{{_t('Name')}}" aria-label="{{_t('Name')}}" aria-describedby="basic-icon-default-fullname2" required />
                            </div>
                            @error('name')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            @include('components.phone_with_code', ['user' => $admin])
                            @error('phone')
                            <span class="text-danger">{{$message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="email" value="{{old('email') ?? $admin->email}}" id="basic-icon-default-email" class="form-control" placeholder="{{_t('Email')}}" aria-label="{{_t('Email')}}" aria-describedby="basic-icon-default-email2" required />
                            </div>
                            @error('email')
                            <span class="text-danger">{{$message }}</span>
                            @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="password" name="password" value="{{old('password')}}" value="{{old('password')}}" id="basic-icon-default-email" class="form-control" placeholder="******" aria-label="john.doe" aria-describedby="basic-icon-default-email2" />
                            </div>
                            @error('password')
                            <span class="text-danger">{{$message }}</span>
                            @enderror
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="file" name="image" id="basic-icon-default-email" accept="image/*" class="form-control" aria-describedby="basic-icon-default-email2" />
                            </div>
                            @if($admin->getFirstMedia('profile')?->getUrl())
                            <div class="col-lg-6 col-md-6 mb-sm-0">
                                <img src="{{ $admin->getFirstMedia('profile')?->getUrl() }}" id="profile-img" alt="" class="rounded-circle" style="width: 30px; height: 30px;" />
                            </div>
                            @endif
                            @error('image')
                            <span class="text-danger">{{$message }}</span>
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <div class="col-sm-10">
                                    <select id="role_id" name="role_id" class="role_select2 form-select" data-allow-clear="true" required>
                                        ...
                                        <option value="{{$role->id}}" {{ $admin->hasRole($role->name) ? 'selected' : null }}>{{$role->name}}</option>
