        ...
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tbody class="table-border-bottom-0 text-center">
                    {{-- Expenses --}}
                    <tr>
                        <td colspan="5" class="bg-light">حقوق الملكية</td>
                    ...
                    {{-- Bills --}}
                    <tr>
                        <td colspan="5" class="bg-light">الأصول الثابتة</td>
                    ...
                    {{-- Orders --}}
                    <tr>
                        <td colspan="5" class="bg-light">اخرى</td>
                    ...
                    @endif
                    <tr>
                        <td colspan="5" class="bg-light">الأصول المتداولة
                        </td>
                    </tr>
                    @php $total = $total_tax = 0 @endphp
                    <tr>
                    ...
                    <tr class="text-center">
                        <td colspan="5">{{ _t('Total') . ': 0 | ' . _t('Total Tax') . ' : 0' }}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5" class="bg-light"> الخصوم المتداولة
                        </td>
                    </tr>
                    @php $total = $total_tax = 0 @endphp
                    <tr>
                    ...
                    <tr>
                        <td colspan="5" class="bg-light"> أصول مدينة اخرى
                        </td>
                    </tr>
                    @php $total = $total_tax = 0 @endphp
                    <tr>
                    ...
                    <tr>
                        <td colspan="5" class="bg-light">خصوم دائنة أخرى
                        </td>
                    </tr>
                    @php $total = $total_tax = 0 @endphp
                    <tr>
