    ...
    <script>
        $(document).ready(function() {
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('driver.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
    ...
    <div class="card">
        <div class="card-header border-bottom">
            ...
            <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
                ...
                <div class="col-md-4">
                    <a href="{{ route('driver.create') }}" class="btn btn-primary mb-3"
                        id="newUserButton">{{ _t('New Driver') }}</a>
                </div>
            </div>
        </div>
