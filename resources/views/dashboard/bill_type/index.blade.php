    ...
    <script>
        $(document).ready(function() {
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('bill.type.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            var color = data.static ? 'success' : 'primary';
                            var type = data.static ? "{{ _t('Static') }}" : "{{ _t('Normal') }}";
                            return (
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return (
                                ...
                                @can('update_bill')
                                    '<a href="' + route('bill-type.edit', data.id) +
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">{{ _t('Bill Types') }}</h5>
    ...
    <!--  -->
    <!-- Modal -->
    <div class="modal-onboarding modal fade animate__animated" id="newTypeModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body p-0">
                    <div class="onboarding-content mb-0">
                        <h4 class="onboarding-title text-body">{{ _t('New Type') }}</h4>
                        <form method="POST" action="{{ route('bill-type.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" name="description" value="{{ old('description') ?? '' }}"
                                            class="form-control" id="basic-icon-default-fulldescription"
                            ...
                            <div class="row mb-3">
                                <label class="col-sm-2 col-form-label"
                                    for="basic-icon-default-fullname">{{ _t('Static') }} *</label>
                                <div class="col-sm-10">
                                    <label class="switch switch-primary">
                                        <input type="checkbox" name="static" title="Activate"
                                            class="switch-input static-input" />
                                        <span class="switch-toggle-slider">
                                            <span class="switch-on">
                                                <i class="ti ti-check"></i>
                                            </span>
                            ...
                            <div class="row mb-3 price-div d-none">
                                <label class="col-sm-2 col-form-label"
                                    for="basic-icon-default-fullname">{{ _t('Price') }} *</label>
                                <div class="col-sm-10">
                                    <div class="input-group input-group-merge">
                                        <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                                class="ti ti-comment"></i></span>
                                        <input type="number" step="any" name="price" value="{{ old('price') }}"
                                            class="form-control price-input" id="basic-icon-default-fullname"
