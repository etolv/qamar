    ...
    <script>
        ...
        <tbody>`;
            ...
            <tr>
                ...
                if (selectedCoupon) {
                    if (selectedCoupon.is_percentage) {
                        discount = totalAmount * selectedCoupon.discount / 100;
                    } else {
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('booking.store') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="flatpickr-datetime">{{ _t('Date') }} *</label>
                            <div class="col-sm-10">
                                @php
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <!-- <input type="datetime-local" name="date" min="{{ $now }}" value="{{ old('date') }}" class="form-control" id="basic-icon-default-date" placeholder="{{ _t('Date') }}" aria-describedby="basic-icon-default-fullname2" required /> -->
                                    <input type="text" class="form-control" name="date" min="{{ $now }}"
                                        value="{{ old('date') }}" placeholder="YYYY-MM-DD HH:MM"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-2">
                                                ...
                                                <input type="number" name="services[0][quantity]" id="form-repeater-1-2"
                                                    class="form-control" placeholder="{{ _t('Quantity') }}" required />
                                            </div>
                                            <div class="mb-3 col-1">
                                                <label class="form-label" for="remover">{{ _t('') }}</label>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea name="address" class="form-control" id="basic-icon-default-fullsku" placeholder="{{ _t('address') }}"
                                        aria-describedby="basic-icon-default-fullsku2" rows="3" required>{{ old('address') }}</textarea>
                                </div>
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                ...
                                <div data-repeater-list="group-a">
                                    <div data-repeater-item>
                                        <div class="row mb-3">
                                            ...
                                            <input type="hidden" id="lat" value="25.285443" name="lat">
                                            <input type="hidden" id="lng" value="51.531079" name="lng">
                                        </div>
                                    </div>
                                </div>
                            </div>
