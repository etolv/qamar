...
@section('title', 'Rate reasons List')
...
@section('page-script')
    <script>
        $(document).ready(function() {
            ...
            if (hasErrors) {
                $('#newReasonModal').modal('show');
            }
            window.deleteOptions('RateReason');
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('rate.reason.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return (
                                ...
                                @can('update_category')
                                    '<a href="' + route('rate-reason.edit', data.id) +
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">{{ _t('Rate Reasons') }}</h5>
            <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
                ...
                <div class="col-md-4">
                    @can('create_rate')
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newReasonModal">
                            {{ _t('New Rate Reason') }}
                        </button>
                    @endcan
                </div>
    ...
    <!--  -->
    <!-- Modal -->
    <div class="modal-onboarding modal fade animate__animated" id="newReasonModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body p-0">
                    <div class="onboarding-content mb-0">
                        <h4 class="onboarding-title text-body">{{ _t('New Reason') }}</h4>
                        <form method="POST" action="{{ route('rate-reason.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
