...
@section('title', 'Temp Attendance List')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('attendance.temp.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3 page-title">{{ _t('Temp Attendance') }}</h5>
            <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
                ...
                <div class="col-md-3 justify-content-end">
                    <a href="{{ route('attendance.temp.clear') }}" class="btn btn-primary mb-3"
                        id="newUserButton">{{ _t('Clear') }}</a>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body p-0">
                    <div class="onboarding-content mb-0">
                        ...
                        <form method="POST" action="{{ route('attendance.temp.import') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
