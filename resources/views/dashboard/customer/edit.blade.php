...
@section('vendor-script')
    @vite(['resources/assets/vendor/libs/quill/katex.js', 'resources/assets/vendor/libs/quill/quill.js', 'resources/assets/vendor/libs/dropzone/dropzone.js', 'resources/assets/vendor/libs/jquery-repeater/jquery-repeater.js', 'resources/assets/vendor/libs/flatpickr/flatpickr.js', 'resources/assets/vendor/libs/tagify/tagify.js', 'resources/assets/vendor/libs/select2/select2.js', 'resources/assets/vendor/libs/leaflet/leaflet.js'])
@endsection
    ...
    <div class="row">
        ...
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('customer.update', $customer->user->id) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="name" value="{{ $customer->user->name }}" required
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-icon-default-email">{{ _t('Phone') }}
                                *</label>
                            <div class="col-sm-10">
                                @include('components.phone_with_code', ['user' => $customer->user])
                                @error('phone')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <div class="col-sm-10">
                                        <select id="branch_id" name="branch_id" class="branch_select2 form-select"
                                            data-allow-clear="true" required>
                                            @if ($customer->branch)
                                                <option value="{{ $customer->branch_id }}">{{ $customer->branch?->name }}
                                                </option>
                                            @endif
                                        </select>
                                    </div>
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea name="address" value="{{ old('address') }}" id="basic-icon-default-email" class="form-control"
                                        aria-label="john.doe" aria-describedby="basic-icon-default-email2"> {{ old('address') ?? $customer->address }}</textarea>
                                </div>
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                @if ($customer->user->getFirstMedia('profile')?->getUrl())
                                    <div class="col-lg-6 col-md-6 mb-sm-0">
                                        <img src="{{ $customer->user->getFirstMedia('profile')?->getUrl() }}"
                                            id="profile-img" alt="" class="rounded-circle"
