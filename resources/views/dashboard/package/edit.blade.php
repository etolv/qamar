    ...
    <div class="row">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                @if ($package->getFirstMedia('image'))
                                    <img src="{{ $package->getFirstMediaUrl('image') }}" id="profile-img" alt=""
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') ?? $package->name }}"
                                        class="form-control" id="basic-icon-default-date" placeholder="{{ _t('Name') }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="ti ti-clipboard"></i></span>
                                    <input type="date" name="start_date" min="{{ $package->start_date }}"
                                        value="{{ old('start_date') ?? $package->start_date }}" class="form-control"
                                        id="basic-icon-default-date" placeholder="{{ _t('Start Date') }}"
                                        aria-describedby="basic-icon-default-fullname2" required />
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="date" name="end_date" min="{{ $now }}"
                                        value="{{ old('end_date') ?? $package->end_date }}" class="form-control"
                                        id="basic-icon-default-date" placeholder="{{ _t('End Date') }}"
                                        aria-describedby="basic-icon-default-fullname2" required />
                                    <!-- <input type="text" class="form-control" name="date" min="{{ $now }}" value="{{ old('date') }}" placeholder="YYYY-MM-DD HH:MM" id="flatpickr-datetime" /> -->
                                </div>
                                @error('end_date')
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    ...
                                    <textarea name="description" class="form-control" id="basic-icon-default-fullsku"
                                        placeholder="{{ _t('Description') }}" aria-describedby="basic-icon-default-fullsku2" rows="3">{{ old('description') ?? $package->description }}</textarea>
                                </div>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
            ...
            <div class="card-body repeater-service-wrapper">
                <div class="repeater-service-items">
                    <div class="repeater-service-item">
                        <div class="row">
                            <div class="mb-3 col-6">
                                <label class="form-label" for="service-repeater-1-1">{{('Services')}}</label>
                                <select id="service-repeater-1-1" name="services[0][id]" class="service_select2_1 form-select" data-allow-clear="true" required>
                                </select>
                            </div>
                            <div class="mb-3 col-2">
                                <label class="form-label" for="form-repeater-1-2">{{_t('Quantity')}}</label>
                                <input type="number" name="services[0][quantity]" id="form-repeater-1-2" class="form-control" placeholder="{{_t('Quantity')}}" required />
                            </div>
                            <div class="mb-3 col-2">
                                <label class="form-label" for="service-price-repeater-1-2">{{_t('Price')}}</label>
                                <input type="number" name="services[0][price]" id="service-price-repeater-1-2" class="form-control" placeholder="{{_t('Price')}}" required />
                            </div>
                            <div class="mb-3 col-1">
                                <label class="form-label" for="remover">{{_t('')}}</label>
                ...
                <div class="row">
                    <div class="col-md-6 mt-3">
                        <button class="btn btn-primary repeater-service-add"><i class="fa-solid fa-plus"></i></button>
                    </div>
                </div>
            </div>
        </div>
        <div class="card mb-4">
            ...
            <div class="card-body repeater-wrapper">
                <div class="repeater-items">
                    <div class="repeater-item">
                        <div class="row">
                            ...
                            <div class="mb-3 col-2">
                                <label class="form-label" for="price-repeater-1-2">{{_t('Price')}}</label>
                                <input type="number" name="stocks[0][price]" id="price-repeater-1-2" class="form-control" placeholder="{{_t('Price')}}" required />
                            </div>
                            <div class="mb-3 col-1">
                                <label class="form-label" for="remover">{{_t('')}}</label>
                                <button class="btn btn-danger repeater-remove"><i class="fa-solid fa-trash"></i></button>
                ...
                <div class="row">
                    <div class="col-md-6 mt-3">
                        <button class="btn btn-primary repeater-add"><i class="fa-solid fa-plus"></i></button>
                    </div>
                </div>
            </div>
        </div>
