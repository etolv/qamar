    ...
    <script>
        $(document).ready(function() {
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('payment.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            if (data.card) {
                                return `<span>${data.card.name} - ${data.card.number}</span>`;
                            } else {
                                return '';
                            }
                        }
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">{{ _t('Payments') }}</h5>
