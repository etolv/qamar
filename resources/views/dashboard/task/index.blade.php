    ...
    <script>
        $(document).ready(function() {
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('task.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
                        ...
                        data: function(data, type, full, meta) {
                            ...
                            data.user_data.map((user) => {
                                html += `
                                        ...
                                        <a href="${route('employee.show', user.type_id)}" target="_blank">
                                        <img class="h-auto rounded-circle" src="${user.image}" alt="Avatar" />
                                        </a>
                                        </li>`
                            });
                            html += `</ul>`;
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            return (
                                ...
                                `<a href="${route('task.show', data.id)}" class="text-body" ><i class="ti ti-eye ti-sm mx-2"></i></a>` +
                                // editButton +
                                deleteButton +
