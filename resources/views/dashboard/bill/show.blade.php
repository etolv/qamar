    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
            ...
            <div class="d-flex align-content-center flex-wrap gap-2">
                ...
                @if ($bill->getFirstMedia('file'))
                    <p class="text-body">
                        <a href="{{ $bill->getFirstMediaUrl('file') }}" download class="btn btn-success"><i
        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="w-25 sorting_disabled" rowspan="1" colspan="1" style="width: 94px;"
                                            aria-label="price">{{ _t('Purchase Unit') }}</th>
                                        <th class="w-25 sorting_disabled" rowspan="1" colspan="1" style="width: 94px;"
                                            aria-label="price">{{ _t('Purchase Unit') }}</th>
                                        <th class="w-25 sorting_disabled" rowspan="1" colspan="1" style="width: 94px;"
                                            aria-label="price">{{ _t('Purchase Price') }}</th>
                                        <th class="w-15 sorting_disabled" rowspan="1" colspan="1" style="width: 85px;"
                                            aria-label="qty">{{ _t('Tax') }}</th>
                                        <th class="w-25 sorting_disabled" rowspan="1" colspan="1" style="width: 94px;"
                                            aria-label="price">{{ _t('Exchange Price') }}</th>
                                        <th class="w-25 sorting_disabled" rowspan="1" colspan="1" style="width: 94px;"
                                            aria-label="price">{{ _t('Sell Price') }}</th>
                                        <th class="w-15 sorting_disabled" rowspan="1" colspan="1" style="width: 85px;"
                                            aria-label="qty">{{ _t('Purchase qty') }}</th>
                                        <th class="w-15 sorting_disabled" rowspan="1" colspan="1" style="width: 85px;"
                                            aria-label="qty">{{ _t('Sell qty') }}</th>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($bill->billProducts as $billProduct)
                                        <tr class="odd">
                                                ...
                                                <div class="d-flex justify-content-start align-items-center text-nowrap">
                                                    <div class="avatar-wrapper">
                                                        <div class="avatar me-2"><img
                                                                src="{{ $billProduct->product->getFirstMedia('image') ? $billProduct->product->getFirstMediaUrl('image') : asset('assets/img/illustrations/default.png') }}"
                                                                alt="" class="rounded-2"></div>
                                                    </div>
                                                    <div class="d-flex flex-column">
                                                        <h6 class="text-body mb-0 text-wrap">
                                                            {{ Illuminate\Support\Str::limit($billProduct->product->name, 30, '...') }}
                                                        </h6>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td><span>{{ 'SAR ' . $billProduct->tax }}</span></td>
                                            ...
                                            <td><span
                                                    class="text-body">{{ $billProduct->quantity * $billProduct->convert }}</span>
                                            </td>
                                            <td>
                                                <h6 class="mb-0 text-nowrap">
                                                    {{ 'SAR ' . $billProduct->purchase_price * $billProduct->quantity }}
                                                </h6>
                                            </td>
                                        </tr>
                                    @endforeach
                        ...
                        <div class="d-flex justify-content-end align-items-center m-3 mb-2 p-1">
                            <div class="order-calculations">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <h6 class="mb-0">SAR {{ $bill->tax }}</h6>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                                    <span class="w-px-100 text-heading">{{ _t('Grand Total') }}:</span>
                                    <h6 class="mb-0">SAR {{ $bill->grand_total }}</h6>
                                </div>
                                <div class="d-flex justify-content-between mb-2">
                ...
                @php
                    ...
                    $left_dept = $bill->grand_total - $paid_amount;
                @endphp
                                ...
                                <table class="datatables-order-details table border-top dataTable no-footer dtr-column"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="control sorting_disabled" rowspan="1" colspan="1"
                                                aria-label="">{{ _t('Card') }}</th>
                                            <th class="control sorting_disabled" rowspan="1" colspan="1"
                                                aria-label="">{{ _t('Date') }}</th>
                                            <th class="control sorting_disabled" rowspan="1" colspan="1"
                                                aria-label="">{{ _t('File') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($bill->payments as $payment)
                                            <tr class="odd">
                                                ...
                                                <td class="control" tabindex="0">
                                                    {{ $payment->card?->name . ' - ' . $payment->card?->number }}</td>
                                                <td class="control" tabindex="0">
                                                    {{ Carbon\Carbon::parse($payment->created_at)->format('Y-m-d H:i') }}
                                                </td>
                                                <td class="control" tabindex="0">
                                                    @if ($payment->getFirstMedia('file'))
                                                        <a href="{{ $payment->getFirstMediaUrl('file') }}" download
                                                            class="text-body"><i
                                                                class="ti ti-download ti-sm me-2"></i></a>
                                                    @endif
                                                </td>
                                            </tr>
                                        @endforeach
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-start align-items-center mb-4">
                            <div class="avatar me-2">
                                <img src="{{ $bill->supplier->getFirstMedia('profile') ? $bill->supplier->getFirstMediaUrl('profile') : asset('assets/img/illustrations/NoImage.png') }}"
                        ...
                        <div class="d-flex justify-content-start align-items-center mb-4">
                            ...
                            <h6 class="text-body text-nowrap mb-0">{{ $bill->supplier->bills->count() }}
                                {{ _t('Bills') }}</h6>
                        </div>
        ...
        <!-- Modals -->
        <div class="modal-onboarding modal fade animate__animated" id="newPaymentModal" tabindex="-1"
            aria-hidden="true">
                    ...
                    <div class="modal-body p-0">
                        <div class="onboarding-content mb-0">
                            ...
                            <form id="newPaymentForm" method="POST"
                                action="{{ route('bill.payment.store', $bill->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row mb-3">
                                    <label class="col-sm-2 col-form-label"
                                        for="basic-icon-default-fullname">{{ _t('Type') }} *</label>
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <select id="payment_type" name="type" class="payment_select2 form-select"
                                ...
                                <div class="row mb-3 card-div d-none">
                                    <label class="col-sm-2 col-form-label"
                                        for="basic-icon-default-email">{{ _t('Card') }}
                                        *</label>
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <span class="input-group-text"><i
                                                    class="fa-solid fa-usdollar-sign"></i></span>
                                            <input type="number" min="0" max="{{ $left_dept }}"
                                                name="amount" id="total-repeater-1-2" value="0"
                                                class="form-control total-repeater-1" placeholder="{{ _t('Amount') }}"
                                                required />
                                        </div>
                                        @error('phone')
                                            <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group input-group-merge">
                                            <span class="input-group-text"><i
                                                    class="fa-solid fa-usdollar-sign"></i></span>
                                            <input type="file" accept="*" name="file" id="total-repeater-1-2"
