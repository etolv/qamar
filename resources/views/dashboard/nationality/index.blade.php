...
@section('page-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            window.deleteOptions('Nationality');
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('nationality.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return (
                                ...
                                @can('update_nationality')
                                    '<a href="' + route('nationality.edit', data.id) +
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">{{ _t('Nationalities') }}</h5>
            <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
                ...
                <div class="col-md-4">
                    @can('create_nationality')
                        <a href="{{ route('nationality.create') }}" class="btn btn-primary mb-3"
                            id="newUserButton">{{ _t('New nationality') }}</a>
                    @endcan
                </div>
            </div>
        </div>
