...
<div class="row">
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="post" action="{{route('nationality.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                <span id="basic-icon-default-fullname2" class="input-group-text"><i class="ti ti-tag"></i></span>
                                <input type="text" name="country" value="{{old('country')}}" class="form-control" id="basic-icon-default-country" placeholder="{{_t('country')}}" aria-label="{{_t('country')}}" aria-describedby="basic-icon-default-country2" required />
                            </div>
                            @error('country')
                            <span class="text-danger">{{$message }}</span>
                            @enderror
