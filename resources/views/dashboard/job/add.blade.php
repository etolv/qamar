                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <input type="text" name="title" value="{{old('title')}}" required class="form-control" id="basic-icon-default-fulltitle" placeholder="{{_t('Title')}}" aria-label="{{_t('Title')}}" aria-describedby="basic-icon-default-fulltitle2" required />
                            </div>
                            @error('title')
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                <select name="section" class="form-select select2">
                                    ...
                                    <option value="{{$section->value}}">{{$section->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            @error('section')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                                ...
                                <textarea name="description" id="basic-icon-default-email" class="form-control" aria-label="john.doe" aria-describedby="basic-icon-default-email2" required> {{old('description')}}</textarea>
                            </div>
                            @error('description')
                            <span class="text-danger">{{$message }}</span>
                            @enderror
