            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('product.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span id="basic-icon-default-fullname2" class="input-group-text"><i
                                            class="ti ti-clipboard"></i></span>
                                    <input type="number" name="min_quantity" value="{{ old('min_quantity') ?? 0 }}"
                                        required class="form-control" id="basic-icon-default-fullmin_quantity"
                                    ...
                                    <div class="col-sm-10">
                                        <select id="consumption_type" name="consumption_type"
                                            ...
                                            @foreach (App\Enums\ConsumptionTypeEnum::cases() as $consumption_type)
                                                <option value="{{ $consumption_type->value }}" selected>
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label"
                                for="basic-icon-default-email">{{ _t('Brand') }}</label>
                            <div class="col-sm-10">
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text"><i class="ti ti-settings"></i></span>
                                    <div class="col-sm-10">
