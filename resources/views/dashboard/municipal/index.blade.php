...
@section('page-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            window.deleteOptions('Municipal');
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('municipal.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return (
                                ...
                                '<a href="' + route('municipal.edit', data.id) +
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">{{ _t('Municipals') }}</h5>
            <div class="d-flex justify-content-between align-items-center row pb-2 gap-3 gap-md-0">
                <div class="col-md-4 user_role"></div>
                <div class="col-md-4 user_plan"></div>
                <div class="col-md-4 user_status"></div>
                <div class="col-md-4">
                    @can('create_municipal')
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#newMunicipalModal">
                            {{ _t('New Municipal') }}
                        </button>
                    @endcan
                </div>
    ...
    <!-- Modal -->
    <div class="modal-onboarding modal fade animate__animated" id="newMunicipalModal" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-content text-center">
                ...
                <div class="modal-body p-0">
                    <div class="onboarding-content mb-0">
                        <h4 class="onboarding-title text-body">{{ _t('New Municipal') }}</h4>
                        <form method="POST" action="{{ route('municipal.store') }}" enctype="multipart/form-data">
                            @csrf
