    ...
    <script>
        $(document).ready(function() {
            ...
            var dataTable = $('.datatables-users-test').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('unit.fetch') }}", // Adjust the URL based on your Laravel route
                    type: 'GET',
                    headers: {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            return (
                                ...
                                @can('update_unit')
                                    '<a href="' + route('unit.edit', data.id) +
...
@section('content')
    ...
    <div class="card">
        <div class="card-header border-bottom">
            <h5 class="card-title mb-3">{{ _t('Units') }}</h5>
                ...
                <div class="col-md-4">
                    @can('create_unit')
                        <a href="{{ route('unit.create') }}" class="btn btn-primary mb-3"
                            id="newUserButton">{{ _t('New Unit') }}</a>
                    @endcan
                </div>
            </div>
        </div>
